...
const TaskDialog = ({ task, onTaskDeleted }) => {
  ...
  const deleteHandler = async () => {
    try {
      // Call onTaskDeleted to notify parent about the deletion
  ...
  const deleteClicks = () => {
    setOpenDialog(true); // Show confirmation dialog before deleting
  };
  ...
  return (
    <>
      ...
      <AddTask open={openEdit} setOpen={setOpenEdit} task={task} isEdit={true} key={new Date().getTime()} />
